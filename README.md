...
For a more up-to-date and maintained version, check out: [ComfyUI-FLOAT_Optimized](https://github.com/set-soft/ComfyUI-FLOAT_Optimized)
...
- `a_cfg_scale`: Audio classifier-free guidance scale (default:1)
